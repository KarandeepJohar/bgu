...
int main(int argc, char **argv) {
    ...
    slice.compile_to_file("bgu_1x4", {r_sigma, s_sigma, splat_loc, values, slice_loc}, "bgu_1x4", target);

    // Compile a version that just does the fitting. Use this with the GL shader.
    line.compile_to_file("fit_only_1x4", {r_sigma, s_sigma, splat_loc, values, slice_loc}, "fit_only_1x4", target);
